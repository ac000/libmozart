...
libmozart: libmozart.o player-operations.o playlist-operations.o
	gcc -shared -Wl,-soname,libmozart.so.0 -o libmozart.so.0.0 libmozart.o player-operations.o playlist-operations.o -lc $(INCS) $(LIBS)
...
playlist-operations.o: playlist-operations.h playlist-operations.c
	gcc -fPIC -Wall -c playlist-operations.c $(INCS) $(LIBS)
